...
| [0003](0003-identity-is-provider-subject.md) | Identity is a `(provider, subject)` pair | accepted |
| [0004](0004-github-required-to-publish.md) | GitHub identity is required to publish | accepted |
